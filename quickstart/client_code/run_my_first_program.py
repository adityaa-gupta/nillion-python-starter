...
import os
from py_nillion_client import SecretInteger
...
async def main():
    ...
    new_secret = nillion.NadaValues(
        {
            "payment_history_weight": SecretInteger(35),
            "credit_utilization_weight": SecretInteger(30),
            "debt_to_income_weight": SecretInteger(20),
            "credit_history_length_weight": SecretInteger(10),
            "inquiries_weight": SecretInteger(5),
        }
    )
    ...
    compute_bindings.add_input_party("creditor", party_id)
    compute_bindings.add_input_party("debtor", party_id)
    compute_bindings.add_output_party("debtor", party_id)

    # Add my_int2, the 2nd secret at computation time
    computation_time_secrets = nillion.NadaValues({
      "payment_history": SecretInteger(8500),
      "credit_utilization": SecretInteger(3000),
      "debt_to_income": SecretInteger(50),
      "credit_history_length": SecretInteger(1500),
      "inquiries": SecretInteger(200),
    })
